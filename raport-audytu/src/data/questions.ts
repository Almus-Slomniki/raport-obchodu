...
export const initialQuestions: Question[] = [
  { id: "1", text: "Zaleganie kurzu i ścinek w pile", images: [], description: "(przykłady niezgodności: widoczne ścinki z dnia poprzedniego (brudne, inny produkt itp.), posadzka zakryta ścinkami, nagromadzone ścinki poza taśmociągiem itp.)" },
